...
function makeDistroChart(settings) {
    ...
    function tooltipHover2(groupName, metrics) {
        var tooltipString = "<li class='list-group-item list-group-item-primary'>Group: " + groupName + "</li>";
        tooltipString += "<li class='list-group-item'>Max: " + formatAsFloat(metrics.max, 0.1) + "</li>";
        tooltipString += "<li class='list-group-item'>Q3: " + formatAsFloat(metrics.quartile3) + "</li>";
        tooltipString += "<li class='list-group-item'>Median: " + formatAsFloat(metrics.median) + "</li>";
    ...
    ! function prepareChart() {
        ...
        //         chart.objs.tooltip
        //             .style("display", null)
        //             .style("left", (d3.event.pageX*2/3) + "px")
        ...
        for (var cName in chart.groupObjs) {
            chart.groupObjs[cName].g = chart.objs.g.append("g").attr("class", "group");
            chart.groupObjs[cName].g.on("mouseover", function (self) {
                $('div.mertic').removeClass("hidden");
            }).on("mouseout", function () {
                // $('div.mertic').addClass("hidden");
            }).on("mousemove", tooltipHover2(cName, chart.groupObjs[cName].metrics))
        }
        chart.update();
    }();
